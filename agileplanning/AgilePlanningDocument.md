...
This is a compilation of all artefacts of this project using Github projects.  This document will contain links and snapshots to and of User Stories , Product Backlog and Sprint Plan.
...
Using the **INVEST criteria** user stories were created and saved to a seperate view [User Story View](https://github.com/users/mehluli-dlamini-219105359/projects/1/views/6)
...
Using MoSCoW prioritization and effort estimates (fibonacci sequence) to view all items , you can click on this link [Product Backlog](https://github.com/users/mehluli-dlamini-219105359/projects/1/views/7)
...
Defined sprint goal and plan for two weeks , created subtasks based on User Stories. [Sprint Plan](https://github.com/users/mehluli-dlamini-219105359/projects/1/views/8)
